...
export default {
  ...
  setup() {
    ...
    const productDescriptions = reactive({
      旅平險: [
        { iconUrl: "../Vue_Insurance2/travelc.png", title: "身故" },
        { iconUrl: "../Vue_Insurance2/travelc1.png", title: "意外醫療" },
        { iconUrl: "../Vue_Insurance2/travelc2.png", title: "突發疾病" },
        { iconUrl: "../Vue_Insurance2/travelc3.png", title: "醫療專機" },
      ],
      登山險: [
        { iconUrl: "../Vue_Insurance2/hikeinjure2.png", title: "緊急救援" },
        { iconUrl: "../Vue_Insurance2/hikeinjure3.png", title: "高山症" },
        { iconUrl: "../Vue_Insurance2/hikeinjure1.png", title: "意外傷害" },
        { iconUrl: "../Vue_Insurance2/travelc.png", title: "身故" },

      ],
      意外險: [
        { iconUrl: "../Vue_Insurance2/accident2.png", title: "失能保障" },
        { iconUrl: "../Vue_Insurance2/accident1.png", title: "意外身故" },
        { iconUrl: "../Vue_Insurance2/accident3.png", title: "骨折" },
        { iconUrl: "../Vue_Insurance2/accident4.png", title: "燒燙傷" },
      ],
      醫療險: [
        { iconUrl: "../Vue_Insurance2/medical1.png", title: "住院保障" },
        { iconUrl: "../Vue_Insurance2/medical2.png", title: "手術費用" },
        { iconUrl: "../Vue_Insurance2/medical3.png", title: "身故給付" },
        { iconUrl: "../Vue_Insurance2/medical4.png", title: "其他給付" },
      ],
      壽險: [
        { iconUrl: "../Vue_Insurance2/specificdisease.png", title: "特定傷病" },
        { iconUrl: "../Vue_Insurance2/travelc.png", title: "失能保障" },
        { iconUrl: "../Vue_Insurance2/age.png", title: "祝壽金" },
        { iconUrl: "../Vue_Insurance2/medical3.png", title: "身故給付" },
      ],
      汽車險: [
        { iconUrl: "../Vue_Insurance2/car2.png", title: "第三責任" },
        { iconUrl: "../Vue_Insurance2/car1.png", title: "車損保障" },
        { iconUrl: "../Vue_Insurance2/accident2.png", title: "駕駛意外" },
        { iconUrl: "../Vue_Insurance2/medical4.png", title: "其他給付" },
      ],
    });
